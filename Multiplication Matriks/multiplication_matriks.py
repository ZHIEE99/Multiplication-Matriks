...
Original file is located at
    https://colab.research.google.com/drive/1bQeXurdiz63DrE3EYN8wAa22AXZwSC-o
"""
...
if st.button("✨ Hitung Hasil Perkalian ✨", key="calculate_button", type="primary", use_container_width=True):
    if matrix_a_input is not None and matrix_b_input is not None:
        ...
        cols_a = matrix_a_input.shape[-1] if matrix_a_input.ndim > 1 else 0
        rows_b = matrix_b_input.shape[-2] if matrix_b_input.ndim > 1 else 0
